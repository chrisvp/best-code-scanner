#!/usr/bin/env python3
"""
Simple test executor that runs one model through all prompt/finding combinations.

Usage: python run_model_tests.py <model_name>
"""
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print("Usage: python run_model_tests.py <model_name>")
        sys.exit(1)
